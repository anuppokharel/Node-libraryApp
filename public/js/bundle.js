...
var showAlert = function showAlert(type, message) {
  ...
  document.querySelector('body').insertAdjacentHTML('afterbegin', markup); // Inserts at the beginning of the body
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 5:
            ...
            if (res.data.status === 'success') {
              (0, _alert.showAlert)('success', 'Registration successful!');
              window.setTimeout(function () {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            url = type === 'password' ? 'http://127.0.0.1:3000/api/user/update' : 'http://127.0.0.1:3000/api/user/updateMe';
            _context.next = 4;
            return (0, _axios.default)({
              method: 'PATCH',
              url: url,
...
},{"axios":"../../node_modules/axios/index.js","./alert":"alert.js"}],"indexS.js":[function(require,module,exports) {
"use strict";
...
var changePasswordBtn = document.getElementById('btn--change-password'); // Delegation
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              _context.next = 10;
              return (0, _register.register)(form);
...
},{"./login.js":"login.js","./register":"register.js","./updateSetting":"updateSetting.js"}],"../../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
},{}]},{},["../../node_modules/parcel-bundler/src/builtins/hmr-runtime.js","indexS.js"], null)
